...
public class frmColorForm extends JFrame {
	...
	public frmColorForm() {
		...
		JButton btnChangeColor = new JButton("Èçìåíèòü öâåò ôîðìû");
		btnChangeColor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(contentPane.getBackground()==Color.RED) {
					contentPane.setBackground(Color.GREEN);
					lblNameColor.setText("Çåë¸íûé");
				}
				else {
					contentPane.setBackground(Color.RED);
					lblNameColor.setText("Êðàñíûé");
				}
			}
		});
		btnChangeColor.setBounds(35, 22, 176, 33);
